...
async function getCk() {
    ...
    if($request&&$request.url.indexOf("info")>=0) {
        const farmurlVal = $request.url.split(`?`)[1]        
          if (farmurlVal) {            
            if (awyapp[_0x4156cd]) {
                awyapp[_0x4156cd]['farmurl'] = farmurlVal;
            } else {
                awyapp[_0x4156cd] = {
                    'farmurl': farmurlVal,
                };
            ...
            $.setdata(farmurlVal,`farmurl${$.idx}`)
          }
            ...
            if(jrttfarmKey){
                if (awyapp[_0x4156cd]) {
                    awyapp[_0x4156cd]['farmkey'] = jrttfarmKey;
                } else {
                    awyapp[_0x4156cd] = {
                        'farmkey': jrttfarmKey,
                    };
                ...
                $.setdata(jrttfarmKey,`farmkey${$.idx}`)
              }
            }
        ...
        const signurlVal = $request.url.split(`?`)[1]
          if (signurlVal) {
            if (awyapp[_0x4156cd]) {
                awyapp[_0x4156cd]['signurl'] = signurlVal;
            } else {
                awyapp[_0x4156cd] = {
                    'signurl': signurlVal,
                };
            ...
            $.setdata(signurlVal,`signurl${$.idx}`)
          }
          }
      ...
      //$.log(jrttsignKey)
        if(jrttsignKey.indexOf("STUB")>=0){
            if (awyapp[_0x4156cd]) {
                awyapp[_0x4156cd]['signkey'] = jrttsignKey;
            } else {
                awyapp[_0x4156cd] = {
                    'signkey': jrttsignKey,
                };
      ...
      //article = article.replace(/\d{3}$/, (Math.random()*1e3).toFixed(0).padStart(3,"0"));
          ...
          if(article){
            if (awyapp[_0x4156cd]) {
                awyapp[_0x4156cd]['article'] = jrttsignKey;
            } else {
                awyapp[_0x4156cd] = {
                    'article': jrttsignKey,
                };
          ...
          if (readurlVal){
            if (awyapp[_0x4156cd]) {
                awyapp[_0x4156cd]['readurl'] = readurlVal;
            } else {
                awyapp[_0x4156cd] = {
                    'readurl': readurlVal,
                };
        ...
        if(jrttreadKey){
            if (awyapp[_0x4156cd]) {
                awyapp[_0x4156cd]['readkey'] = jrttreadKey;
            } else {
                awyapp[_0x4156cd] = {
                    'readkey': jrttreadKey,
                };
            ...
            $.setdata(jrttreadKey,`readkey${$.idx}`)
          }
        }        
