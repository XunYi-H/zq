...
async function getCk() {
    if ($request['url']['match'](/\/flame\/user_flame_info/)) {
        ...
        if (awyapp[_0xf35eba]) {
                ...
                awyapp[_0xf35eba]['adTask'] = 0x1;

        } else {
                const _0x438063 = {};
                _0x438063['user_url'] = _0x33c9ce;
                _0x438063['user_headers'] = _0x20028e;
                _0x438063['adTask'] = 0x1;
                awyapp[_0xf35eba] = _0x438063;
        }
        resdata = await upck(JSON.stringify(ua),awyapp[_0xf35eba])
        try{            
            awyapp[_0xf35eba]['sqlid'] = resdata.data.id
        }catch{
            print(resdata)
        }finally{
...
if ($request['url']['match'](/\/flame\/task\/lottery/)) {
        ...
        if (awyapp[_0x4ac9e1]) {
                ...
                awyapp[_0x4ac9e1]['common_host'] = _0x14346c;
        } else {
                const _0x444a50 = {};
                _0x444a50['common_url'] = _0x29b257;
                _0x444a50['common_headers'] = _0x50d96d;
                _0x444a50['common_host'] = _0x14346c;
                awyapp[_0x4ac9e1] = _0x444a50;
        } 
        resdata = await upck(JSON.stringify(ua),awyapp[_0x4ac9e1])
        try{            
            awyapp[_0x4ac9e1]['sqlid'] = resdata.data.id
        }catch{
            print(resdata)
        }finally{
            $['setdata'](JSON['stringify'](awyapp, null, 0x2), 'dyhsbapp');
...
if ($request['url']['match'](/\/commerce\/lottery/)) {
        ...
        if (awyapp[_0x1bf46f]) {
                ...
                const _0x2d4563 = {};
                _0x2d4563['lottery_url'] = _0x5e4562;
                _0x2d4563['lottery_headers'] = _0x9c3ef9;
                awyapp[_0x1bf46f] = _0x2d4563;
        } 
        resdata = await upck(JSON.stringify(ua),awyapp[_0x1bf46f])
        try{            
            awyapp[_0x1bf46f]['sqlid'] = resdata.data.id
        }catch{
            print(resdata)
        }finally{
            $['setdata'](JSON['stringify'](awyapp, null, 0x2), 'dyhsbapp');
...
if ($request['url']['match'](/\/task_system\/task_done/)) {
        ...
        if (awyapp[_0x3c404f]) {
                ...
                const _0x3c8f28 = {};
                _0x3c8f28['ad_url'] = _0x1844e3;
                _0x3c8f28['ad_headers'] = _0x17519a;
                awyapp[_0x3c404f] = _0x3c8f28;
        } 
        resdata = await upck(JSON.stringify(ua),awyapp[_0x3c404f])
        try{            
            awyapp[_0x3c404f]['sqlid'] = resdata.data.id
        }catch{
            print(resdata)
        }finally{
            $['setdata'](JSON['stringify'](awyapp, null, 0x2), 'dyhsbapp');
...
if ($request['url']['match'](/\/gift\/list/)) {
        ...
        if (awyapp[_0x3d10c9]) {
                ...
                const _0x222961 = {};
                _0x222961['farm_url'] = _0x490568;
                _0x222961['farm_headers'] = _0x15758c;
                awyapp[_0x3d10c9] = _0x222961;        
        }  
        resdata = await upck(JSON.stringify(ua),awyapp[_0x3d10c9])
        try{            
            awyapp[_0x3d10c9]['sqlid'] = resdata.data.id
        }catch{
            print(resdata)
        }finally{
            $['setdata'](JSON['stringify'](awyapp, null, 0x2), 'dyhsbapp');
