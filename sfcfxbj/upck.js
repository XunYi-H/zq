...
async function getCk() {
    if($request.url.indexOf(`cgi-bin/userinfo.fcgi`) > -1 && $request.headers.Cookie) {
        ...
        if (awyapp[_0x23050f]) {
            ...
            awyapp[_0x23050f]['qlskey'] = qlskey ;
            awyapp[_0x23050f]['qluin'] = qluin;
        } else {
            awyapp[_0x23050f] = {
                'openid': openid,
                'qlskey': qlskey,
        ...
        $['setdata'](JSON['stringify'](awyapp, null, 0x2), 'txzxg');
        $['msg']($['name'], '基础数据获取成功！🎉');
        return  
    }
