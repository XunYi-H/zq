...
async function getCk() {
    if ($request['url']['indexOf']('v2/login') > -1) {
        const _0x428e18 = $request['headers'];
        const _0x1c55ad = $request['body'];
        console.log($request['body']);
        const ua = $request['headers']['User-Agent'];
        let _0x406326 = djxsuserck - 0x1;
        if (djxsapp[_0x406326]) {
            djxsapp[_0x406326]['haierhd'] = _0x428e18;
            djxsapp[_0x406326]['haierbody'] = _0x1c55ad;
        } else {
            djxsapp[_0x406326] = {
                'haierhd': _0x428e18,
                'haierbody': _0x1c55ad,
        ...
        try{
            ...
            $['setdata'](JSON['stringify'](djxsapp, null, 0x2), 'hezjapp');
            $['msg']($['name'], '数据获取成功！🎉');
        }
    }
