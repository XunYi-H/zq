...
async function getCk() {
    if ($request.url.indexOf("new") > -1 && $request.url.indexOf("pool") > -1) {
        ...
        if (awyapp[_0x13466c]) {
            awyapp[_0x13466c]['qkhqhd'] = qkhqhd;
            awyapp[_0x13466c]['qkhqver'] = qkhqver;
            awyapp[_0x13466c]['qkhqua'] = qkhqua;
        } else {
            awyapp[_0x13466c] = {
                'qkhqhd': qkhqhd,
                'qkhqver': qkhqver,
        ...
        try{            
            ...
            $['setdata'](JSON['stringify'](awyapp, null, 0x2), 'qkhqapp');
        }
        $['msg']($['name'], '去看行情' + (_0x13466c + 0x1) + '权限数据获取成功！🎉');
    }
}
