...
async function getCk() {
    if ($request['url']['match'](/\/readEssay/)) {
        ...
        let _0x15e6be = awyuserck - 1;
        if (awyapp[_0x15e6be]) {
                awyapp[_0x15e6be]['headers'] = _0x49c7c0;
                awyapp[_0x15e6be]['imei'] = _0x48ec30;
                awyapp[_0x15e6be]['user_id'] = _0x2c472e;
                awyapp[_0x15e6be]['user_name'] = _0x55e1af;
        } else {
                const _0x57b000 = {};
                _0x57b000['headers'] = _0x49c7c0;
                _0x57b000['imei'] = _0x48ec30;
                _0x57b000['user_id'] = _0x2c472e;
                _0x57b000['user_name'] = _0x55e1af;
                awyapp[_0x15e6be] = _0x57b000;                
        }
        const ua = $request['headers']['User-Agent'];
        resdata = await upck(JSON.stringify(ua),awyapp[_0x15e6be])
        try{            
            awyapp[_0x15e6be]['sqlid'] = resdata.data.id
        }catch{
            print(resdata)
        }finally{
            $['setdata'](JSON['stringify'](awyapp, null, 0x2), 'jkttapp');
        }  
        $['msg']($['name'], '基础数据获取成功！🎉');
        return
    }
