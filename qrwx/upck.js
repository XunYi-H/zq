...
const $ = new Env('奇瑞车主小程序');
let awyuserck = 1;
let awyapp = $['getjson']('qrczxcx', []);
let appid = 13;
...
async function getCk() {
    if ($request['url']['match'](/\/oil\/drawStatus/)) {
        ...
        try{            
            ...
            $['setdata'](JSON['stringify'](awyapp, null, 0x2), 'qrczxcx');
        }
        $['msg']($['name'], '奇瑞车主小程序' + (_0x13466c + 0x1) + '权限数据获取成功！🎉');
    }
}
