              ...
              if(bsxxlhd){
                if(bsxxlbody){
                    if (djxsapp[_0x406326]) {
                        djxsapp[_0x406326]['bsxxlhd'] = bsxxlhd;
                        djxsapp[_0x406326]['bsxxlbody'] = bsxxlbody;
                    } else {
                        djxsapp[_0x406326] = {
                            'bsxxlhd': bsxxlhd,
                            'bsxxlbody': bsxxlbody,
                    ...
                    try{
                        ...
                        $['setdata'](JSON['stringify'](djxsapp, null, 0x2), 'bsxxlapp');
                    }
                    $['msg']($['name'], '宝石消消乐' + (_0x406326 + 0x1) + '数据获取成功！🎉');
