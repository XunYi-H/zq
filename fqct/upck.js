...
const $ = new Env('番茄畅听app');
let awyuserck = 1;
let awyapp = $['getjson']('fqctapp', []);
let appid = 6;
    ...
    if ($request['url']['match'](/sign_in/)) {
        ...
        if (awyapp[_0x4d111d]) {
            if (_0x286f35['indexOf']('android') != -0x1) {
                awyapp[_0x4d111d]['fqct_android_url'] = _0x286f35;
                awyapp[_0x4d111d]['fqct_android_host'] = _0x5f4ef3;
                awyapp[_0x4d111d]['fqct_android_headers'] = _0x45b5b4;
            } else {
                awyapp[_0x4d111d]['fqct_url'] = _0x286f35;
                awyapp[_0x4d111d]['fqct_host'] = _0x5f4ef3;
                awyapp[_0x4d111d]['fqct_headers'] = _0x45b5b4;
            }
        } else {
            if (_0x286f35['indexOf']('android') != -0x1) {
                awyapp[_0x4d111d] = {
        ...
        resdata = await upck(JSON.stringify(ua),awyapp[_0x4d111d])
        try{            
            awyapp[_0x4d111d]['sqlid'] = resdata.data.id
        }catch{
            print(resdata)
        }finally{
            $['setdata'](JSON['stringify'](awyapp, null, 0x2), 'fqctapp');
        }
        if (_0x286f35['indexOf']('android') != -0x1) {
            $['msg']($['name'], '番茄畅听账号' + (_0x4d111d + 0x1) + ':\x20安卓端数据获取成功！🎉');
        } else {
            $['msg']($['name'], '番茄畅听账号' + (_0x4d111d + 0x1) + ':\x20苹果端数据获取成功！🎉');
        }
    }
}
