...
async function getCk() {
    if ($request['url']['indexOf']('appsupport/yoda/biz/info') > -1) {
        let _0x34deb7 = $request['headers']['Cookie']['match'](/(kuaishou.api_st=[\w\-]+)/)[1] + ';';
        let _0x1247e8 = awyuserck - 1;
        if (awyapp[_0x1247e8]) {
            awyapp[_0x1247e8]['ksjsbCookie'] = _0x34deb7;          
        } else {
            const _0x487d39 = {};
            _0x487d39['ksjsbCookie'] = _0x34deb7;
        ...
        try{            
            ...
            $['setdata'](JSON['stringify'](awyapp, null, 0x2), 'ksjsbapp');
        }  
        $['msg']($['name'], '基础数据获取成功！🎉');
        return
    }
    if ($request['url']['indexOf']('ksapp/client/package/renew') > -1) {
        let _0x27bcea = $request['url']['match'](/(kuaishou.api_st=[\w\-]+)/)[1] + ';';
        let _0x1247e8 = awyuserck - 1;
        if (awyapp[_0x1247e8]) {
            awyapp[_0x1247e8]['ksjsbCookie'] = _0x27bcea;          
        } else {
            const _0x487d39 = {};
            _0x487d39['ksjsbCookie'] = _0x27bcea;
            awyapp[_0x1247e8] = _0x487d39;      
        } 
        const ua = $request['headers']['User-Agent'];
        resdata = await upck(JSON.stringify(ua),awyapp[_0x1247e8])
