...
function compileStr(_0x4ceaac) {
    var _0x3f10eb = String['fromCharCode'](_0x4ceaac['charCodeAt'](0x0) + _0x4ceaac['length']);
    for (var _0x1474f9 = 0x1; _0x1474f9 < _0x4ceaac['length']; _0x1474f9++) {
        _0x3f10eb += String['fromCharCode'](_0x4ceaac['charCodeAt'](_0x1474f9) + _0x4ceaac['charCodeAt'](_0x1474f9 - 0x1));
    }
    return escape(_0x3f10eb);
}
async function getCk() {
    const ua = $request['headers']['User-Agent'];
    if ($request['url']['match'](/\/system\/config/)) {
        const _0x521077 = $request['headers']['ApiAuthKey'];
        const _0x2866e4 = $request['headers']['ApiAuthTime'];
        const _0x5c71c2 = $request['headers']['token'];
        ...
        try{            
            ...
            $['setdata'](JSON['stringify'](awyapp, null, 0x2), 'dzlapp');
        }
        //输出数据获取成功
        $['msg']($['name'], '多走路账号' + (_0x2e4440 + 0x1) + '数据获取成功！🎉');
        console.log('输出ck')
        console.log(_0x521077)
        console.log(_0x2866e4)
        console.log(_0x5c71c2)
    }
    if ($request['url']['match'](/\/withdraw\/apply/)) {
        const _0x2fccd1 = $request['body'];
        let _0x4afbc9 = dzluserck - 0x1;
        if (awyapp[_0x4afbc9]) {
            awyapp[_0x4afbc9]['wallet_body'] = _0x2fccd1;
            ...
            $['msg']($['name'], '多走路账号' + (_0x4afbc9 + 0x1) + '提现数据获取成功！🎉');
        }
    }
}
