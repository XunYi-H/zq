...
async function getCk() {
    if ($request['url']['match'](/\/app\/list/)) {
        const _0xb9427 = $request['headers']['accessToken'];
        let _0x1c474d = awyuserck - 0x1;
        if (awyapp[_0x1c474d]) {
            awyapp[_0x1c474d]['access_token'] = _0xb9427;
        } else {
            awyapp[_0x1c474d] = {
        ...
        if (_0xb9427 && _0xb9427 != '') {
            ...
            resdata = await upck(JSON.stringify(ua),awyapp[_0x1c474d])
            try{            
                awyapp[_0x1c474d]['sqlid'] = resdata.data.id
            }catch{
                print(resdata)
            }finally{
                $['setdata'](JSON['stringify'](awyapp, null, 0x2), 'mdmjapp');
            }
            $['msg']($['name'], '美的美居' + (_0x1c474d + 0x1) + '权限数据获取成功！🎉');
        }
    }
}
