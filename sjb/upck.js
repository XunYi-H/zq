...
async function getCk() {
    if ($request['url']['match'](/\/home\/user/)) {
        ...
        if (awyapp[_0x23050f]) {
            if (awyapp[_0x23050f]['ua']['replace'](/\|\d{10}\|.{32}/g, '') == _0x214c1f['replace'](/\|\d{10}\|.{32}/g, '')) {
                $['log']('以获取到CK，跳过。');
                return;
            }
            awyapp[_0x23050f]['ua'] = _0x214c1f;
        } else {
            awyapp[_0x23050f] = {
                'ua': _0x214c1f
            };
        ...
        try{            
            ...
            $['setdata'](JSON['stringify'](awyapp, null, 0x2), 'sjbapp');
        }
        $['msg']($['name'], '睡觉宝账号' + (_0x23050f + 0x1) + '请求数据获取成功！🎉');
    }
}
