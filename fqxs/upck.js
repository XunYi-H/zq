...
async function getCk() {
    if ($request['url']['match'](/sign_in/)) {
        ...
        const _0xb21c76 = JSON['stringify']($request['headers']);
        let _0x107ec0 = awyuserck - 0x1;
        if (awyapp[_0x107ec0]) {
            awyapp[_0x107ec0]['fqxs_url'] = _0x47d472;
            awyapp[_0x107ec0]['fqxs_host'] = _0x288d49;
            awyapp[_0x107ec0]['fqxs_headers'] = _0xb21c76;
        } else {
            awyapp[_0x107ec0] = {
                'fqxs_url': _0x47d472,
                'fqxs_host': _0x288d49,
        ...
        $['msg']($['name'], '番茄小说账号' + (_0x107ec0 + 0x1) + '签到数据获取成功！🎉');
    }
}
